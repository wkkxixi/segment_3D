    ...
    with open(meta_file) as f:
        ...
        for item in lines:
            if item.__contains__('.'):  # escape the first line and recognize the path
                ...
                gt = item.replace('images', 'ground_truth_original_plus3')
...
def single_img_prediction(gt, pred):
    ...
    for t in range(-10, 275, 5):
        precision, recall = compute_scores(gt, pred, t)
...
def group_img_prediction(dataset_folder, runID):
    ...
    from os.path import join as pjoin
    import numpy
    meta_file = pjoin(dataset_folder, 'meta.txt')
    precision_list = None
    recall_list = None
...
if __name__ == "__main__":
    ...
    parser.add_argument(
        ...
        nargs="?",
        type=str,
        default="/home/heng/Research/isbi/",
    ...
    parser.add_argument(
        ...
        nargs="?",
        type=str,
        default="/home/heng/Research/isbi/fly-dataset/flyJanelia2",
