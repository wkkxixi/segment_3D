...
class unet3dregStudent(nn.Module):
    def __init__(
        self,
        feature_scale=4,
        n_classes=1,
        ...
        super(unet3dregStudent, self).__init__()
        ...
        self.conv2 = unetConv2_3d_regression(filters[1], filters[2], self.is_batchnorm)
    ...
    def forward(self, inputs):
        ...
        conv2 = self.conv2(maxpool2)
        log('unet3dregStudent: after conv2 size is {}'.format(conv2.size()))



        up2 = self.up_concat2(conv_mid, conv2)
